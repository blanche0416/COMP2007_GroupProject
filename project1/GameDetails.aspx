                ...
                <asp:GridView runat="server" ID="TeamsGridView" CssClass="table table-striped table-border table-hover"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Details" Text="<i class='fa fa-pencil-square-o fa-lg'></i> Details"
                            NavigateUrl="~/TeamDetails.aspx.cs" ControlStyle-CssClass="btn btn-primary btn-sm" runat="server" DataNavigateUrlFields="TeamID" DataNavigateUrlFormatString="TeamDetails.aspx?TeamID={0}" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
